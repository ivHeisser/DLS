...
## **Основной objective**:
познакомиться основными идеями геометрического ML (e.g. Equivariant Neural Networks) и топологического анализа данных (e.g. комплексом Вьеториса — Рипса и кучей расширений PCA) с последующем практическим применение для задач физики и/или drug design
