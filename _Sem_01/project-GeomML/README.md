...
Проектное задание DLS-spring-2026 находится в [ноутбуке](notebooks/dplr-qm9/dplr.ipynb), а ноутбук в [директории](notebooks/dplr-qm9), там же [README.md](notebooks/dplr-qm9/README.md) :)
